...
var renameStrings = [
  ...
  [ 'Yeti\WPDispensarySync\', pkg.config.php_namespace ], // PHP namespace for your plugin
  [ 'Yeti\WPDispensarySync\\\', pkg.config.php_namespace.replace( /\\/g, '\\\\' ) ], // Rename Composer namespace
